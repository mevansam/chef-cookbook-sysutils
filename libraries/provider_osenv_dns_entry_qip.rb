		...
		class DnsEntry
			...
			class Qip < Chef::Provider
				...
				def load_current_resource
					...
					qip_server_info = Chef::EncryptedDataBagItem.load("service_endpoints", "qip", encryption_key)[node.chef_environment] if !encryption_key.nil?
					...
					@name_address_mapping = results[0]

					@address_name_mapping = results[1]
					@address_name_mapping.chomp!(".") if !@address_name_mapping.nil? && !@address_name_mapping.empty?

					@alias_name_mapping = results[2]
